...
CREATE TABLE IF NOT EXISTS countries (
	...
	is_guarantor	BIT(1)		NULL DEFAULT 0,
...
DELIMITER $$
CREATE PROCEDURE insert_import_data()
BEGIN
	INSERT INTO money (
		end_of_period,
		loan_number,
...
-- Use Table Data Import Wizard to get the .csv file into the table "import_data"
-- or
